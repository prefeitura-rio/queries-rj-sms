...
with
    ...
    final as (
        ...
        left join cpf_profissionais on profissionais_datasus.cns = cpf_profissionais.cns
        left join
            cbo_agg
            on profissionais_datasus.id_codigo_sus = cbo_agg.profissional_codigo_sus
        left join
            conselho_agg
            on profissionais_datasus.id_codigo_sus
            = conselho_agg.profissional_codigo_sus
    )
