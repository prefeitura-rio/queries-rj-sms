{{
    config(
        alias="receituario_controle_especial",
        materialized="table",
...
with source as (
    ...
    receituario_filtrado as (
        ...
        where json_value(doc, '$.tipo') = 'RECEITUÁRIO DE CONTROLE ESPECIAL'
    ),
    ...
    receituario as (
        select
            ...
            json_extract_scalar(doc_receituario, '$.data') as receituario_data,
