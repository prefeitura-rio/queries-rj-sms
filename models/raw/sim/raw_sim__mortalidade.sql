...
SELECT
  ...
  {{ process_null("DTREGCART") }} as data_registro_cartorio,
  {{ process_null("TIPOBITO") }} as tipo_obito,
  {{ process_null("DTOBITO") }} as data_obito,
  {{ process_null("HORAOBITO") }} as hora_obito,
  ...
  {{ process_null("DTNASC") }} as data_nascimento,
  ...
  {{ process_null("DTATESTADO") }} as dt_atestado,
  ...
  {{ process_null("DTINVESTIG") }} as dt_investigacao,
  ...
  {{ process_null("DTCADASTRO") }} as dt_cadastro,
  ...
  {{ process_null("DTRECEBIM") }} as dt_recebimento,
  {{ process_null("ATESTADO") }} as atestado,
  {{ process_null("CAUSABAS_R") }} as causa_bas_r,
  {{ process_null("DTRESSELE") }} as dt_ressele,
  ...
  {{ process_null("DTRECORIG") }} as dt_recorrigido,
