...
teste_rapido_flat AS (
  SELECT
    ...
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hiv01TestResult') AS hiv01testresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hiv02TestResult') AS hiv02testresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].antihiv_gestanteTestResult') AS antihiv_gestantetestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].antihiv_parceiroTestResult') AS antihiv_parceirotestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hepb_gestanteTestResult') AS hepb_gestantetestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hepb_parceiroTestResult') AS hepb_parceirotestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hepb_pop_geralTestResult') AS hepb_pop_geraltestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hepc_gestanteTestResult') AS hepc_gestantetestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hepc_parceiroTestResult') AS hepc_parceirotestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].hepc_pop_geralTestResult') AS hepc_pop_geraltestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].treponemico_sifilis_gestanteTestResult') AS treponemico_sifilis_gestantetestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].treponemico_sifilis_parceiroTestResult') AS treponemico_sifilis_parceirotestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].proteinuriaTestResult') AS proteinuriatestresult,
    JSON_EXTRACT_SCALAR(data, '$.teste_rapido[0].tbTestResult') AS tbtestresult,
