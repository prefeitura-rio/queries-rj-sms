...
select
    ...
    safe_cast(NULLIF(DATA_CADASTRO, 'None') as date format 'DD/MM/YYYY') as data_cadastro_inicial,
    safe_cast(NULLIF(DATA_ULTIMA_ATUALIZACAO_DO_CADASTRO, 'None') as date format 'DD/MM/YYYY') as data_ultima_atualizacao_cadastral,
