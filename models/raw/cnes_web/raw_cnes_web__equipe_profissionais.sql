...
select
    ...
    safe_cast({{process_null('dt_entrada')}} as string) as data_entrada_profissional,
    safe_cast({{process_null('dt_desligamento')}} as string) as data_desligamento_profissional,
