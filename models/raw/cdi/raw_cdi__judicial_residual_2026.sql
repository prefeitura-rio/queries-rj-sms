...
select
  ...
  {{ cdi_parse_date('concluido_em', 'processo_rio__sei', 'oficio') }} as data_conclusao,
...
from {{ source("brutos_cdi_staging", "judicial_residual_2026") }}