{{
    config(
        alias        = "sinanrio_legado__tb_investiga",
        materialized = "table",
...
with
    ...
    extrair_informacoes as (
        select
            ...
            SAFE_CAST({{ process_null('nu_notificacao') }} AS STRING) AS nu_notificacao,
            ...
            -- campos de investigação / tratamento
            ...
            SAFE_CAST(nu_contato AS INT64) AS nu_contato,
