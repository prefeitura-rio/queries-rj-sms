...
WITH
    ...
    fato_prenatal AS (
        SELECT
            ...
            SAFE_CAST({{ process_null('param_peso') }} AS NUMERIC(16,4)) AS param_peso,
            SAFE_CAST({{ process_null('param_tamin') }} AS NUMERIC(16,4)) AS param_tamin,
            SAFE_CAST({{ process_null('param_tamax') }} AS NUMERIC(16,4)) AS param_tamax,
            SAFE_CAST({{ process_null('consseguintes_afu') }} AS NUMERIC(16,4)) AS consseguintes_afu,
            {{ process_null('edema') }} AS edema,
            {{ process_null('observacoes') }} AS observacoes,
            SAFE_CAST({{ process_null('pconsulta_peso_habitual') }} AS NUMERIC(16,4)) AS pconsulta_peso_habitual,
            SAFE_CAST({{ process_null('pconsulta_altura') }} AS NUMERIC(16,4)) AS pconsulta_altura,
            SAFE_CAST({{ process_null('pconsulta_idade_gestacional') }} AS NUMERIC(16,4)) AS pconsulta_idade_gestacional,
            ...
            SAFE_CAST({{ process_null('aval_risco_prenatal_total_indices') }} AS NUMERIC(16,4)) AS aval_risco_prenatal_total_indices,
            {{ process_null('agraval_risco_prenatal_escala_nunomont') }} AS agraval_risco_prenatal_escala_nunomont,
            SAFE_CAST({{ process_null('exames_lab_glicemia_pos_50') }} AS NUMERIC(16,4)) AS exames_lab_glicemia_pos_50,
            {{ process_null('exames_lab_tcoombs') }} AS exames_lab_tcoombs,
            SAFE_CAST({{ process_null('exames_lab_glicemia_jejum') }} AS NUMERIC(16,4)) AS exames_lab_glicemia_jejum,
            SAFE_CAST({{ process_null('exames_lab_ptgo_0') }} AS NUMERIC(16,4)) AS exames_lab_ptgo_0,
            SAFE_CAST({{ process_null('exames_lab_ptgo_60') }} AS NUMERIC(16,4)) AS exames_lab_ptgo_60,
            SAFE_CAST({{ process_null('exames_lab_ptg_120') }} AS NUMERIC(16,4)) AS exames_lab_ptg_120,
            SAFE_CAST({{ process_null('exames_lab_ptg_180') }} AS NUMERIC(16,4)) AS exames_lab_ptg_180,
            SAFE_CAST({{ process_null('exames_lab_creatinemia') }} AS NUMERIC(16,4)) AS exames_lab_creatinemia,
            {{ process_null('exames_lab_vdrl') }} AS exames_lab_vdrl,
            {{ process_null('exames_lab_toxoplasmose_imun') }} AS exames_lab_toxoplasmose_imun,
            SAFE_CAST({{ process_null('exames_lab_rubeola_igg') }} AS NUMERIC(16,4)) AS exames_lab_rubeola_igg,
            SAFE_CAST({{ process_null('exames_lab_rubeola_igm') }} AS NUMERIC(16,4)) AS exames_lab_rubeola_igm,
            {{ process_null('exames_lab_rubeola_imun') }} AS exames_lab_rubeola_imun,
            SAFE_CAST({{ process_null('exames_lab_aghbs') }} AS NUMERIC(16,4)) AS exames_lab_aghbs,
            ...
            SAFE_CAST({{ process_null('pconsulta_dum1') }} AS NUMERIC(16,4)) AS pconsulta_dum1,
            {{ process_null('pconsulta_dpp1') }} AS pconsulta_dpp1,
            {{ process_null('agraval_risco_prenatal_obs') }} AS agraval_risco_prenatal_obs,
            SAFE_CAST({{ process_null('pconsulta_idade_gestacional_dias') }} AS NUMERIC(16,4)) AS pconsulta_idade_gestacional_dias,
            ...
            SAFE_CAST({{ process_null('analises_eritrocitos') }} AS NUMERIC(16,4)) AS analises_eritrocitos,
            SAFE_CAST({{ process_null('analises_hemoglobina') }} AS NUMERIC(16,4)) AS analises_hemoglobina,
            SAFE_CAST({{ process_null('analises_hematocrito') }} AS NUMERIC(16,4)) AS analises_hematocrito,
            SAFE_CAST({{ process_null('analises_gm') }} AS NUMERIC(16,4)) AS analises_gm,
            SAFE_CAST({{ process_null('analises_hgm') }} AS NUMERIC(16,4)) AS analises_hgm,
            SAFE_CAST({{ process_null('analises_chgm') }} AS NUMERIC(16,4)) AS analises_chgm,
            SAFE_CAST({{ process_null('analises_leucocitos') }} AS NUMERIC(16,4)) AS analises_leucocitos,
            SAFE_CAST({{ process_null('analises_neutrifilos') }} AS NUMERIC(16,4)) AS analises_neutrifilos,
            SAFE_CAST({{ process_null('analises_eosinofilos') }} AS NUMERIC(16,4)) AS analises_eosinofilos,
            SAFE_CAST({{ process_null('analises_basofilos') }} AS NUMERIC(16,4)) AS analises_basofilos,
            SAFE_CAST({{ process_null('analises_linfocitos') }} AS NUMERIC(16,4)) AS analises_linfocitos,
            SAFE_CAST({{ process_null('analises_monocitos') }} AS NUMERIC(16,4)) AS analises_monocitos,
            SAFE_CAST({{ process_null('cseguintes_alalises_plaquetas') }} AS NUMERIC(16,4)) AS cseguintes_alalises_plaquetas,
            SAFE_CAST({{ process_null('cseguintes_alalises_acidourico') }} AS NUMERIC(16,4)) AS cseguintes_alalises_acidourico,
            {{ process_null('cseguintes_alalises_citomegalo_virus') }} AS cseguintes_alalises_citomegalo_virus,
            SAFE_CAST({{ process_null('cseguintes_alalises_achbs') }} AS NUMERIC(16,4)) AS cseguintes_alalises_achbs,
            SAFE_CAST({{ process_null('cseguintes_alalises_achbc') }} AS NUMERIC(16,4)) AS cseguintes_alalises_achbc,
            SAFE_CAST({{ process_null('cseguintes_alalises_achvc') }} AS NUMERIC(16,4)) AS cseguintes_alalises_achvc,
            SAFE_CAST({{ process_null('cseguintes_alalises_alfa_proteina') }} AS NUMERIC(16,4)) AS cseguintes_alalises_alfa_proteina,
            SAFE_CAST({{ process_null('cseguintes_alalises_inibinaa') }} AS NUMERIC(16,4)) AS cseguintes_alalises_inibinaa,
            SAFE_CAST({{ process_null('cseguintes_alalises_estradiol') }} AS NUMERIC(16,4)) AS cseguintes_alalises_estradiol,
            SAFE_CAST({{ process_null('cseguintes_alalises_hormona_beta_corionica') }} AS NUMERIC(16,4)) AS cseguintes_alalises_hormona_beta_corionica,
            SAFE_CAST({{ process_null('cseguintes_alalises_tempo_protrombina') }} AS NUMERIC(16,4)) AS cseguintes_alalises_tempo_protrombina,
            SAFE_CAST({{ process_null('cseguintes_alalises_ttrombo_plastina_parcial') }} AS NUMERIC(16,4)) AS cseguintes_alalises_ttrombo_plastina_parcial,
            ...
            SAFE_CAST({{ process_null('pconsulta_dum1dias') }} AS NUMERIC(16,4)) AS pconsulta_dum1dias,
            ...
            SAFE_CAST({{ process_null('pconsulta_tamax') }} AS NUMERIC(16,4)) AS pconsulta_tamax,
            SAFE_CAST({{ process_null('pconsulta_tamin') }} AS NUMERIC(16,4)) AS pconsulta_tamin,
            {{ process_null('dta_eco') }} AS dta_eco,
            {{ process_null('res_mamografias_obs') }} AS res_mamografias_obs,
            SAFE_CAST({{ process_null('cons_seguintes_perimetro_abdominal') }} AS NUMERIC(16,4)) AS cons_seguintes_perimetro_abdominal,
            SAFE_CAST({{ process_null('primeira_consulta_idade_gestacional') }} AS NUMERIC(16,4)) AS primeira_consulta_idade_gestacional,
            SAFE_CAST({{ process_null('primeira_consulta_idade_gestacional_dias') }} AS NUMERIC(16,4)) AS primeira_consulta_idade_gestacional_dias,
            ...
            SAFE_CAST({{ process_null('gestante_gestacoes_num') }} AS NUMERIC(16,4)) AS gestante_gestacoes_num,
            ...
            SAFE_CAST({{ process_null('exames_lab_hemoglobina_d') }} AS NUMERIC(16,4)) AS exames_lab_hemoglobina_d,
            ...
            SAFE_CAST({{ process_null('smpuerperioparametrospeso') }} AS NUMERIC(16,4)) AS smpuerperioparametrospeso,
            SAFE_CAST({{ process_null('smpuerperioparametrostamin') }} AS NUMERIC(16,4)) AS smpuerperioparametrostamin,
            SAFE_CAST({{ process_null('smpuerperioparametrostamax') }} AS NUMERIC(16,4)) AS smpuerperioparametrostamax,
            smpuerperiocitologia AS smpuerperiocitologia,
            SAFE_CAST({{ process_null('smpuerperioalalisesplaquetas') }} AS NUMERIC(16,4)) AS smpuerperioalalisesplaquetas,
            SAFE_CAST({{ process_null('smpuerperioalalisesglicemia') }} AS NUMERIC(16,4)) AS smpuerperioalalisesglicemia,
            SAFE_CAST({{ process_null('smpuerperioalalisescreatinina') }} AS NUMERIC(16,4)) AS smpuerperioalalisescreatinina,
            SAFE_CAST({{ process_null('smpuerperioalalisesgamagt') }} AS NUMERIC(16,4)) AS smpuerperioalalisesgamagt,
            SAFE_CAST({{ process_null('smpuerperioalalisesgot') }} AS NUMERIC(16,4)) AS smpuerperioalalisesgot,
            SAFE_CAST({{ process_null('smpuerperioalalisesgtp') }} AS NUMERIC(16,4)) AS smpuerperioalalisesgtp,
            {{ process_null('smpuerperioalalisesbilirrubinas') }} AS smpuerperioalalisesbilirrubinas,
            SAFE_CAST({{ process_null('smpuerperioalaliseacidourico') }} AS NUMERIC(16,4)) AS smpuerperioalaliseacidourico,
            {{ process_null('smpuerperiourocultura') }} AS smpuerperiourocultura,
            {{ process_null('classificacaotipoparto') }} AS classificacaotipoparto,
            SAFE_CAST({{ process_null('puerperiomcdtsfosfatasealcalina') }} AS NUMERIC(16,4)) AS puerperiomcdtsfosfatasealcalina,
            ...
            SAFE_CAST({{ process_null('gestantepuerperionumrecemnascidos') }} AS NUMERIC(16,4)) AS gestantepuerperionumrecemnascidos,
