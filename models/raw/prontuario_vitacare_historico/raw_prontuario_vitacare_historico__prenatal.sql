...
WITH
    ...
    fato_prenatal AS (
        SELECT
            ...
            SAFE_CAST( {{ process_null(remove_double_quotes('param_peso')) }} AS NUMERIC) AS param_peso,
            SAFE_CAST( {{ process_null(remove_double_quotes('param_tamin')) }} AS NUMERIC) AS param_tamin,
            SAFE_CAST( {{ process_null(remove_double_quotes('param_tamax')) }} AS NUMERIC) AS param_tamax,
            SAFE_CAST( {{ process_null(remove_double_quotes('consseguintes_afu')) }} AS NUMERIC) AS consseguintes_afu,
            {{ process_null(remove_double_quotes('edema')) }} AS edema,
            {{ process_null(remove_double_quotes('observacoes')) }} AS observacoes,
            SAFE_CAST( {{ process_null(remove_double_quotes('pconsulta_peso_habitual')) }} AS NUMERIC) AS pconsulta_peso_habitual,
            SAFE_CAST( {{ process_null(remove_double_quotes('pconsulta_altura')) }} AS NUMERIC) AS pconsulta_altura,
            SAFE_CAST( {{ process_null(remove_double_quotes('pconsulta_idade_gestacional')) }} AS NUMERIC) AS pconsulta_idade_gestacional,
            ...
            SAFE_CAST( {{ process_null(remove_double_quotes('aval_risco_prenatal_total_indices')) }} AS NUMERIC) AS aval_risco_prenatal_total_indices,
            {{ process_null(remove_double_quotes('agraval_risco_prenatal_escala_nunomont')) }} AS agraval_risco_prenatal_escala_nunomont,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_glicemia_pos_50')) }} AS NUMERIC) AS exames_lab_glicemia_pos_50,
            {{ process_null(remove_double_quotes('exames_lab_tcoombs')) }} AS exames_lab_tcoombs,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_glicemia_jejum')) }} AS NUMERIC) AS exames_lab_glicemia_jejum,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_ptgo_0')) }} AS NUMERIC) AS exames_lab_ptgo_0,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_ptgo_60')) }} AS NUMERIC) AS exames_lab_ptgo_60,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_ptg_120')) }} AS NUMERIC) AS exames_lab_ptg_120,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_ptg_180')) }} AS NUMERIC) AS exames_lab_ptg_180,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_creatinemia')) }} AS NUMERIC) AS exames_lab_creatinemia,
            ...
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_rubeola_igg')) }} AS NUMERIC) AS exames_lab_rubeola_igg,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_rubeola_igm')) }} AS NUMERIC) AS exames_lab_rubeola_igm,
            {{ process_null(remove_double_quotes('exames_lab_rubeola_imun')) }} AS exames_lab_rubeola_imun,
            SAFE_CAST( {{ process_null(remove_double_quotes('exames_lab_aghbs')) }} AS NUMERIC) AS exames_lab_aghbs,
