...
WITH
    ...
    fato_hiv AS (
        SELECT
            ...
            {{ remove_double_quotes('aidsdatatransfusao') }} AS aidsdatatransfusao,
            ...
            {{ remove_double_quotes('aidsdatainiciotoxicodependente') }} AS aidsdatainiciotoxicodependente,
            ...
            {{ remove_double_quotes('aidsdatainiciohomosexual') }} AS aidsdatainiciohomosexual,
            ...
            {{ remove_double_quotes('aidsdatainicioheterosexual') }} AS aidsdatainicioheterosexual,
            ...
            {{ remove_double_quotes('aidsdatainiciobisexual') }} AS aidsdatainiciobisexual,
            ...
            {{ remove_double_quotes('aidsdatainicioparceirovih') }} AS aidsdatainicioparceirovih,
            ...
            {{ remove_double_quotes('aidsdoencaatualdtaprovavelinfec') }} AS aidsdoencaatualdtaprovavelinfec,
            ...
            {{ remove_double_quotes('aidsdoencaatualdtinicioqueixas') }} AS aidsdoencaatualdtinicioqueixas,
