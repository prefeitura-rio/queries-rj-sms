...
fato_hiv AS (
    SELECT
        ...
        safe_cast({{ process_null('aidsdoencaatualano1teste') }} AS NUMERIC(16,4)) AS aidsdoencaatualano1teste,
        ...
        safe_cast({{ process_null('aidsdoencaatualemagrecimento') }} AS NUMERIC(16,4)) AS aidsdoencaatualemagrecimento,
        ...
        safe_cast({{ process_null('aidsdoencaatualadenotamanho') }} AS NUMERIC(16,4)) AS aidsdoencaatualadenotamanho,
        ...
        safe_cast({{ process_null('aidsdoencaatualdiarreia') }} AS NUMERIC(16,4)) AS aidsdoencaatualdiarreia,
