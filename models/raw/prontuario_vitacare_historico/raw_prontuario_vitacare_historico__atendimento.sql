...
WITH
    ...
    fato_atendimentos AS (
        SELECT
            ...
            {{ remove_double_quotes('datahora_inicio_atendimento') }} AS datahora_inicio_atendimento,
            {{ remove_double_quotes('datahora_fim_atendimento') }} AS datahora_fim_atendimento,
            {{ remove_double_quotes('datahora_marcacao_atendimento') }} AS datahora_marcacao_atendimento,
            {{ remove_double_quotes('eh_coleta') }} AS eh_coleta,
            {{ remove_double_quotes('subjetivo_motivo') }} AS subjetivo_motivo,
            {{ remove_double_quotes('plano_observacoes') }} AS plano_observacoes,
            {{ remove_double_quotes('avaliacao_observacoes') }} AS avaliacao_observacoes,
            {{ remove_double_quotes('objetivo_descricao') }} AS objetivo_descricao,
            {{ remove_double_quotes('notas_observacoes') }} AS notas_observacoes,
