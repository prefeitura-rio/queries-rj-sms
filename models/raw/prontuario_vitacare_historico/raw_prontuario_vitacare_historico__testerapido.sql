...
WITH
    ...
    fato_testesrapidos AS (
        SELECT
            ...
            {{ process_null('fastingglucose') }} AS glicemia_jejum,
            {{ process_null('postprandialglucose') }} AS glicemia_pos_prandial,
            {{ process_null('capillaryglucose') }} AS glicemia_capilar,
