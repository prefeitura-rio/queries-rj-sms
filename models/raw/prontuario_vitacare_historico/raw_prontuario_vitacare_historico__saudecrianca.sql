...
WITH
    ...
    fato_saudecrianca AS (
        SELECT
            ...
            SAFE_CAST({{ process_null('regcrescaltura') }} AS NUMERIC(16,4)) AS regcrescaltura,
            SAFE_CAST({{ process_null('regcrescpeso') }} AS NUMERIC(16,4)) AS regcrescpeso,
            {{ process_null('observacoes') }} AS observacoes,
            SAFE_CAST({{ process_null('regcrescimc') }} AS NUMERIC(16,4)) AS regcrescimc,
            ...
            SAFE_CAST({{ process_null('pesonascer') }} AS NUMERIC(16,4)) AS pesonascer,
            SAFE_CAST({{ process_null('comprimento') }} AS NUMERIC(16,4)) AS comprimento,
            SAFE_CAST({{ process_null('perimetrocefalico') }} AS NUMERIC(16,4)) AS perimetrocefalico,
            SAFE_CAST({{ process_null('indiceapgar1minuto') }} AS NUMERIC(16,4)) AS indiceapgar1minuto,
            SAFE_CAST({{ process_null('indiceapgar5minuto') }} AS NUMERIC(16,4)) AS indiceapgar5minuto,
            ...
            SAFE_CAST({{ process_null('comcorrecaoesq') }} AS NUMERIC(16,4)) AS comcorrecaoesq,
            SAFE_CAST({{ process_null('semcorrecaoesq') }} AS NUMERIC(16,4)) AS semcorrecaoesq,
            SAFE_CAST({{ process_null('comcorrecaodir') }} AS NUMERIC(16,4)) AS comcorrecaodir,
            SAFE_CAST({{ process_null('semcorrecaodir') }} AS NUMERIC(16,4)) AS semcorrecaodir,
            ...
            SAFE_CAST({{ process_null('triagemautismoscore') }} AS NUMERIC(16,4)) AS triagemautismoscore,
