...
WITH
    ...
    source_saudecrianca AS (
        SELECT 
            ...
            *
        FROM {{ source('brutos_prontuario_vitacare_historico', 'SAUDECRIANCA') }} 
    ),
    ...
    fato_saudecrianca AS (
        SELECT
            ...
            {{ process_null(remove_double_quotes('regcrescaltura')) }} AS regcrescaltura,
            {{ process_null(remove_double_quotes('regcrescpeso')) }} AS regcrescpeso,
            {{ process_null(remove_double_quotes('observacoes')) }} AS observacoes,
            {{ process_null(remove_double_quotes('regcrescimc')) }} AS regcrescimc,
            ...
            {{ process_null(remove_double_quotes('pesonascer')) }} AS pesonascer,
            {{ process_null(remove_double_quotes('comprimento')) }} AS comprimento,
            {{ process_null(remove_double_quotes('perimetrocefalico')) }} AS perimetrocefalico,
            {{ process_null(remove_double_quotes('indiceapgar1minuto')) }} AS indiceapgar1minuto,
            {{ process_null(remove_double_quotes('indiceapgar5minuto')) }} AS indiceapgar5minuto,
            ...
            {{ process_null(remove_double_quotes('denverandasemapoio')) }} AS denverandasemapoio,
            {{ process_null(remove_double_quotes('denverusacolhergarfo')) }} AS denverusacolhergarfo,
            {{ process_null(remove_double_quotes('denverconstroitorre2cubos')) }} AS denverconstroitorre2cubos,
            {{ process_null(remove_double_quotes('denverfala3palavras')) }} AS denverfala3palavras,
            ...
            {{ process_null(remove_double_quotes('comcorrecaoesq')) }} AS comcorrecaoesq,
            {{ process_null(remove_double_quotes('semcorrecaoesq')) }} AS semcorrecaoesq,
            {{ process_null(remove_double_quotes('comcorrecaodir')) }} AS comcorrecaodir,
            {{ process_null(remove_double_quotes('semcorrecaodir')) }} AS semcorrecaodir,
            ...
            {{ process_null(remove_double_quotes('triagemautismoscore')) }} AS triagemautismoscore,
