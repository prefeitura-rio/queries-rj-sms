...
WITH
    ...
    fato_pacientes AS (
        SELECT
            ...
            SAFE_CAST(cadastropermanente AS BOOLEAN) AS cadastropermanente,
            ...
            SAFE_CAST(obito AS BOOLEAN) AS obito,
            ...
            SAFE_CAST(participagrupocomunitario AS BOOLEAN) AS participagrupocomunitario,
            ...
            SAFE_CAST(emsituacaoderua AS BOOLEAN) AS emsituacaoderua,
            ...
            SAFE_CAST(responsavelfamiliar AS BOOLEAN) AS responsavelfamiliar,
            ...
            SAFE_CAST(vulnerabilidadesocial AS BOOLEAN) AS vulnerabilidadesocial,
