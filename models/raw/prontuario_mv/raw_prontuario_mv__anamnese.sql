...
anamnese_renomeado as (
    select
        ...
        safe_cast({{ process_null('pas') }} as int64) as sinais_vitais_pressao_arterial_sistolica,
        safe_cast({{ process_null('pad') }} as int64) as sinais_vitais_pressao_arterial_diastolica,
        safe_cast({{ process_null('fc') }} as int64) as sinais_vitais_frequencia_cardiaca,
        safe_cast({{ process_null('fr') }} as int64) as sinais_vitais_frequencia_respiratoria,
        safe_cast({{ process_null('temp') }} as float64) as sinais_vitais_temperatura,
        safe_cast({{ process_null('spo2') }} as int64) as sinais_vitais_saturacao_oxigenio,
        safe_cast({{ process_null('peso') }} as float64) as sinais_vitais_peso,
        safe_cast({{ process_null('altura') }} as float64) as sinais_vitais_altura,
        safe_cast({{ process_null('imc') }} as float64) as sinais_vitais_imc,
        {{ process_null('descricaoIMC') }} as sinais_vitais_imc_descricao,
        safe_cast({{ process_null('sc') }} as float64) as sinais_vitais_superficie_corporal,
