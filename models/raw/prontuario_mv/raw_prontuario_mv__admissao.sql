...
source as (
    ...
    {% if is_incremental() %}
    where
        TIMESTAMP_TRUNC(datalake_loaded_at, DAY) >= TIMESTAMP(date_sub(current_date('America/Sao_Paulo'), interval 7 day))
    {% endif %}
),
...
admissao as (
    select
        ...
        json_extract_scalar(`data`, '$.pre_natal_qtd_consultas') as pre_natal_qtd_consultas,
        json_extract_scalar(`data`, '$.data_ultima_menstruacao') as data_ultima_menstruacao,
        json_extract_scalar(`data`, '$.data_provavel_parto') as data_provavel_parto,
        json_extract_scalar(`data`, '$.idade_gestacional_semanas') as idade_gestacional_semanas,
        json_extract_scalar(`data`, '$.ultrassonografia_detalhes') as ultrassonografia_detalhes,
        json_extract_scalar(`data`, '$.grupo_sanguineo_mae') as grupo_sanguineo_mae,
        json_extract_scalar(`data`, '$.exame_coombs_indireto') as exame_coombs_indireto,
        ...
        json_extract_scalar(`data`, '$.intercorrencias_gestacao') as intercorrencias_gestacao,
        json_extract_scalar(`data`, '$.uso_drogas_gestacao') as uso_drogas_gestacao,
        json_extract_scalar(`data`, '$.data_hora_nascimento') as data_hora_nascimento,
        json_extract_scalar(`data`, '$.sofrimento_fetal') as sofrimento_fetal,
        json_extract_scalar(`data`, '$.tipo_parto') as tipo_parto,
        json_extract_scalar(`data`, '$.apresentacao_rn_parto') as apresentacao_rn_parto,
        ...
        json_extract_scalar(`data`, '$.drogas_utilizadas_parto') as drogas_utilizadas_parto,
        ...
        json_extract_scalar(`data`, '$.liquido_amniotico_aspecto_volume') as liquido_amniotico_aspecto_volume,
        json_extract_scalar(`data`, '$.avaliacao_apgar') as avaliacao_apgar,
        json_extract_scalar(`data`, '$.manobras_inicias_parto') as manobras_inicias_parto,
        json_extract_scalar(`data`, '$.manobras_reanimacao') as manobras_reanimacao,
        json_extract_scalar(`data`, '$.descricao_reanimacao') as descricao_reanimacao,
        json_extract_scalar(`data`, '$.contato_seio_materno') as contato_seio_materno,
        ...
        json_extract_scalar(`data`, '$.diagnostico_primario') as diagnostico_primario,
        json_extract_scalar(`data`, '$.diagnostico_secundario') as diagnostico_secundario,
        json_extract_scalar(`data`, '$.encaminhamento_pos_nacimento') as encaminhamento_pos_nacimento,
        json_extract_scalar(`data`, '$.plano_terapeutico_rn') as plano_terapeutico_rn,
        ...
        json_extract_scalar(`data`, '$.batimento_cardiaco_1min') as batimento_cardiaco_1min,
        ...
        json_extract_scalar(`data`, '$.batimento_cardiaco_5min') as batimento_cardiaco_5min,
        ...
        json_extract_scalar(`data`, '$.batimento_cardiaco_10min') as batimento_cardiaco_10min,
        json_extract_scalar(`data`, '$.respiracao_10min') as respiracao_10min,
        json_extract_scalar(`data`, '$.tonus_10min') as tonus_10min,
        json_extract_scalar(`data`, '$.irritabilidade_10min') as irritabilidade_10min,
        ...
        json_extract_scalar(`data`, '$.sn_aspiracao_gastrica') as sn_aspiracao_gastrica,
        json_extract_scalar(`data`, '$.sn_aspiracao_traqueal') as sn_aspiracao_traqueal,
        ...
        json_extract_scalar(`data`, '$.ds_justificativa_contato_seio') as ds_justificativa_contato_seio,
        json_extract_scalar(`data`, '$.ds_justificativa_contato_pele') as ds_justificativa_contato_pele,
        json_extract_scalar(`data`, '$.ds_justificativa_banho') as ds_justificativa_banho,
        ...
        json_extract_scalar(`data`, '$.vl_perimetro_cefalico_rn') as vl_perimetro_cefalico_rn,
        json_extract_scalar(`data`, '$.vl_perimetro_toraxico_rn') as vl_perimetro_toraxico_rn,
        json_extract_scalar(`data`, '$.vl_perimetro_abdominal_rn') as vl_perimetro_abdominal_rn,
    ...
    select 
        ...
        safe.parse_datetime('%Y/%m/%d %H:%M:%S', data_nascimento_paciente) as paciente_data_nascimento,
        ...
        safe_cast({{ process_null('gestacoes_numero') }} as int64) as gestacoes_numero,
        safe_cast({{ process_null('partos_numero') }} as int64) as partos_numero,
        safe_cast({{ process_null('aborto_historico') }} as int64) as aborto_historico,
        {{ process_null('pre_natal_realizado') }} as pre_natal_realizado,
        {{ process_null('pre_natal_qtd_consultas') }} as pre_natal_consultas,
        safe.parse_date('%d/%m/%Y', data_ultima_menstruacao) as data_ultima_menstruacao,
        safe.parse_date('%d/%m/%Y', data_provavel_parto) as parto_data_provavel,
        {{ process_null('idade_gestacional_semanas') }} as idade_gestacional_semanas,
        ...
        {{ process_null('liquido_amniotico_aspecto_volume') }} as parto_liquido_amniotico,
        {{ process_null('sofrimento_fetal') }} as parto_sofrimento_fetal,
        {{ process_null('apresentacao_rn_parto') }} as parto_apresentacao_recem_nascido,
        ...
        {{ process_null('vl_perimetro_toraxico_rn') }} as recem_nascido_perimetro_toraxico,
        {{ process_null('vl_perimetro_abdominal_rn') }} as recem_nascido_perimetro_abdominal,
        ...
        {{ process_null('ds_justificativa_contato_seio') }} as contato_seio_justificativa,
        {{ process_null('contato_pele_pele') }} as contato_pele_pele,
        {{ process_null('ds_justificativa_contato_pele') }} as contato_pele_justificativa,
