...
with
    ...
    evolucao_json as (
        select
            ...
            json_extract_scalar(
                data, '$.avaliacao_exames_fisicos'
            ) as avaliacao_exames_fisicos,
            json_extract_scalar(data, '$.conduta_adotada') as conduta_adotada,
            json_extract_scalar(
                data, '$.planejamento_terapeutico'
            ) as planejamento_terapeutico,
            ...
            json_extract_scalar(
                data, '$.sn_profilaxia_medicamento'
            ) as sn_profilaxia_medicamento,
            json_extract_scalar(
                data, '$.sn_profilaxia_deambulacao'
            ) as sn_profilaxia_deambulacao,
            json_extract_scalar(
                data, '$.sn_profilaxia_mecanica'
            ) as sn_profilaxia_mecanica,
            datalake_loaded_at,
            source_updated_at,
        from source
    ),
