...
gestante_json as (
    select 
        ...
        json_extract_scalar(data, '$.ava_sob_ventre_materno') as ava_sob_ventre_materno,
        ...
        json_extract_scalar(data, '$.ds_outro_clampeamento') as ds_outro_clampeamento,
        ...
        json_extract_scalar(data, '$.ds_duracao_parto_assist') as ds_duracao_parto_assist,
        ...
        json_extract_scalar(data, '$.ds_apresentacao_outros') as ds_apresentacao_outros,
        json_extract_scalar(data, '$.ds_anomalia_congenita') as ds_anomalia_congenita,
        json_extract_scalar(data, '$.posicao_vertical') as posicao_vertical,
        json_extract_scalar(data, '$.posicao_semi_vertical') as posicao_semi_vertical,
...
gestante_deduplicado as (
    ...
    qualify row_number() over (partition by id_atendimento, id_cnes order by loaded_at desc) = 1
)
