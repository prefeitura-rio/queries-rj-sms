with source as (
      select * from {{ source('br_ms_cnes', 'estabelecimento') }}
),
renamed as (
    select
        {{ adapter.quote("ano") }},
        ...
        {{ adapter.quote("cep") }},
        {{ adapter.quote("id_estabelecimento_cnes") }} as id_cnes,
        ...
        {{ adapter.quote("quantidade_consultorio_clinica_especializada_ambulatorial") }},
        {{ adapter.quote("quantidade_consultorio_clinica_indiferenciada_ambulatorial") }},
        ...
        {{ adapter.quote("quantidade_sala_cirurgia_ambulatorial_centro_cirurgico") }},
        ...
        {{ adapter.quote("indicador_atendimento_internacao_plano_seguro_terceiro") }},
        ...
        {{ adapter.quote("indicador_atendimento_ambulatorial_plano_seguro_proprio") }},
        {{ adapter.quote("indicador_atendimento_ambulatorial_plano_seguro_terceiro") }},
        {{ adapter.quote("indicador_atendimento_ambulatorial_plano_saude_publico") }},
        {{ adapter.quote("indicador_atendimento_ambulatorial_plano_saude_privado") }},
        ...
        {{ adapter.quote("indicador_atendimento_vigilancia_plano_seguro_terceiro") }},
