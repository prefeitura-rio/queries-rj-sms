...
{% set cols = adapter.get_columns_in_relation(src_new) %}
    ...
    source as (
        {% if not is_incremental() %}
          select
            ...
            data_realizacao,
            prestador_municipio,
            responsavel_resultado as profissional_responsavel_nome,
            cns_resultado as profissional_responsavel_cns,
            conselho as profissional_responsavel_crm,
            data_liberacao_resultado,
            mamografia_tipo,
            mamografia_rastreamento_tipo,
            achado_exame_clinico,
            achado_exame_direita,
            data_ultima_menstruacao,
            numero_filmes,
            mama_direita_pele,
            tipo_mama_direita,
            microcalcificacoes,
            linfonodos_axiliares_direita,
            achados_benignos_direita,
            mama_esquerda_pele,
            tipo_mama_esquerda,
            linfonodos_axiliares_esquerda,
            achados_benignos_esquerda,
            classif_radiologica_direita,
            classif_radiologica_esquerda,
            texto_mamas_labels,
            recomendacoes,
            observacoes_gerais,
            data_extracao,
          ...
          select
            ...
            profissional_responsavel_cns,
            profissional_responsavel_crm,
            data_liberacao_resultado,
            mamografia_tipo,
            mamografia_rastreamento_tipo,
            achado_exame_clinico,
