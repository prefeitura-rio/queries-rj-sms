...
with
  ...
  sisreg_transformed as (
    select
      ...
      cast(safe_cast({{ process_null("data_atualizacao") }} as timestamp) as date) as data_atualizacao,
      ...
      json_value(proceds_json_transformed, '$[0].codigo_interno')     as procedimento_id,
      json_value(proceds_json_transformed, '$[0].descricao_interna')  as procedimento,
      json_value(proceds_json_transformed, '$[0].codigo_sigtap')      as procedimento_sigtap_id,
      ...
      json_value(laudo_json_transformed, '$[0].nome_cnes_operador') as laudo_operador_cnes,
      json_value(laudo_json_transformed, '$[0].operador') as laudo_operador,
      json_value(laudo_json_transformed, '$[0].tipo_perfil') as laudo_perfil_tp,
