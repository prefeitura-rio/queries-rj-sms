...
with
    ...
    medidas_unificadas as (
        select 
            ...
            if((circunferencia_abdominal < 200) and (circunferencia_abdominal > 10), circunferencia_abdominal, null) as circunferencia_abdominal,
            if((frequencia_cardiaca > 30) and (frequencia_cardiaca < 250), frequencia_cardiaca, null) as frequencia_cardiaca,
            if((frequencia_respiratoria < 100) and (frequencia_respiratoria > 5), frequencia_respiratoria, null) as frequencia_respiratoria,
            if((glicemia < 300) and (glicemia > 40), glicemia, null) as glicemia, 
            if((hemoglobina_glicada < 40) and (hemoglobina_glicada > 0), hemoglobina_glicada, null) as hemoglobina_glicada, 
            if((imc < 300) and (imc > 0), imc, null) as imc, 
            if((peso < 500) and (peso > 0), peso, null) as peso, 
            if((pressao_sistolica < 400) and (pressao_sistolica > 0), pressao_sistolica, null) as pressao_sistolica, 
            if((pressao_diastolica < 200) and (pressao_diastolica > 0), pressao_diastolica, null) as pressao_diastolica, 
            pulso_ritmo, 
            if((saturacao_oxigenio < 101) or (saturacao_oxigenio > 20), saturacao_oxigenio, null) as saturacao_oxigenio, 
            if((temperatura < 41) or (temperatura > 30), temperatura, null) as temperatura, 
