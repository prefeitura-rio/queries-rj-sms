    ...
    vacinas as (
       select
            ...
            case
              ...
              when sv.dose = '1st Dose' then '1 dose'
              when sv.dose = '2nd Dose' then '2 dose'
              when sv.dose = '3rd Dose' then '3 dose'
              when sv.dose = '4th Dose' then '4 dose'
              when sv.dose = '5th Dose' then '5 dose'
              when sv.dose = 'Booster' then 'reforco'
              when sv.dose = '1st Booster' then '1 reforco'
              when sv.dose = '2nd Booster' then '2 reforco'
              when sv.dose = '3rd Booster' then '3 reforco'
              when sv.dose = 'Re-Vaccination' then 'revacinacao'
