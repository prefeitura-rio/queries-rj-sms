with
    cmd_sem_outliers as (
        ...
        where outlier = "nao" and row_num <= 60  -- o CMD é calculado a partir das 60 últimas observações
    ...
    cmd_com_outliers as (
        ...
        where row_num <= 60  -- o CMD é calculado a partir das 60 últimas observações
        group by id_cnes, id_material
        order by id_cnes, id_material
    )
