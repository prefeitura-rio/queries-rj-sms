with
    inventory as (
        select * from {{ref("int_estoque__dispensacao_agrupada_por_unidade_abc_e_material")}}  -- curva ABC é calculada a partir dos materiais com maior valor total dispensados
