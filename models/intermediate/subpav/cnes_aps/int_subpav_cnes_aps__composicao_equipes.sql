...
quantitativos_por_equipe as (
    select
        ...
        max(coalesce(inconsistente, 0)) as inconsistente
...
base as (
    select
        ...
        case when e.tipo_equipe_id in (70, 73, 76) then 1 else 0 end as is_equipe_aps,
        case when e.tipo_equipe_id = 70 then 1 else 0 end as is_equipe_esf,
        case when e.tipo_equipe_id = 71 then 1 else 0 end as is_equipe_esb,
        ...
        coalesce(q.inconsistente, 0) as inconsistente
