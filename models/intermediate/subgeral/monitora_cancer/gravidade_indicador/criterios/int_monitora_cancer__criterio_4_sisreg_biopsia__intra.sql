...
{{ monitora_cancer_criterio_intra_evento(
    ...
    source_filter="fonte = 'SISREG' and contains_substr(procedimento, 'BIOPSIA') and data_solicitacao is not null and data_autorizacao is null",
...
{{ monitora_cancer_criterio_intra_evento(
    ...
    intervalo_urgencia=criterio_4_intervalo,
    peso=criterio_4_peso,
    source_filter="fonte = 'SISREG' and contains_substr(procedimento, 'BIOPSIA') and data_autorizacao is not null and data_execucao is null",
