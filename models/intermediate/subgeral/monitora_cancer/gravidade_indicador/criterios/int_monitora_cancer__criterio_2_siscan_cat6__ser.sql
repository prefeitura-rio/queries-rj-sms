...
-- (diagnóstico). Desfecho esperado: qualquer evento no SER. Folga: 5 dias.
...
with
    ...
    -- Desfecho esperado: qualquer evento SER (mesma definição usada no
    -- critério 3; cópia local para manter cada arquivo autossuficiente).
