...
with
    ...
    profissional_ftp as (
        select
            ...
            sigla_uf,
            utils.clean_numeric_string(cartao_nacional_saude) as profissional_cns,
            utils.clean_name_string(nome) as profissional_nome,
            cbo_2002 as id_cbo,
            ...
            utils.clean_numeric_string(id_registro_conselho) as id_registro_conselho,
